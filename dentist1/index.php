...
$conn = mysqli_connect('localhost','root','','contact_db1') or die('connection failed');
...
<div class="container">
   <div  class="row align-items-center">
      ...
      <div  class="col-md-6 content">
         ...
         <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laboriosam cupiditate vero in provident ducimus. Totam quas labore mollitia cum nisi, sint, expedita rem error ipsa, nesciunt ab provident. Aperiam, officiis!</p></p>
         <a href="#contact" class="link-btn">make appointment</a>
